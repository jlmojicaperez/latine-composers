...
composer_args.add_argument("image_id", type=str, required=False)
...
composer_args.add_argument(
    "tag_ids", type=int, action="append", required=False)
...
composer_update_args.add_argument("image_id", type=int, required=False)
...
composer_update_args.add_argument(
    "country_of_education_id", type=int, required=False)

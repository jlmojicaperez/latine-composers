...
composer_update_args.add_argument("tag_ids", type=int, action="append", required=False)
...
image_args.add_argument("image_file", type=FileStorage, location="files", required=True, help="An image file is required")